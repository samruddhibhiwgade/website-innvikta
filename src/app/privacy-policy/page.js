...
const PrivacyPolicy = () => {
  return (
    <GSAPWrapper>
      <SeoMeta 
        title="Privacy Policy | Innvikta" 
        description="Privacy Policy for Innvikta Cybersecurity Solutions. Learn how we collect, use, and protect your information." 
      />
      <div className="min-h-screen bg-white">
        {/* Banner Section - Matches the Start Free Page */}
        ...
        {/* Content Section - Matches the padding, typography and spacing of site layouts */}
          ...
          <div className="container px-6 md:px-12 lg:px-24">
            <div className="w-full">
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6 font-medium">
                Welcome to Innvikta Cybersecurity Solutions (&ldquo;Innvikta&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;). Your privacy is important to us. This Privacy Policy explains how we collect, use, store, protect, and disclose your information when you visit our website, use our cybersecurity awareness platform, or interact with our services.
              </p>
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">1. Information We Collect</h3>
              
              <h4 className="text-lg font-bold text-dark mb-2 mt-6">Information You Provide</h4>
              ...
              <h4 className="text-lg font-bold text-dark mb-2 mt-6">Information Collected Automatically</h4>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h4 className="text-lg font-bold text-dark mb-2 mt-6">Platform Usage Data</h4>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">2. How We Use Your Information</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">3. Cookies and Similar Technologies</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">4. Analytics</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">5. Marketing Communications</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">6. Information Sharing</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">7. Data Security</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">8. Data Retention</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">9. International Data Transfers</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">10. Your Privacy Rights</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">12. Third-Party Links</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">13. Compliance</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">14. Digital Personal Data Protection Act (DPDPA) – India</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h4 className="text-lg font-bold text-dark mb-2 mt-6">Lawful Processing</h4>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <ul className="list-disc pl-6 mb-6 space-y-2 text-slate-650 text-base md:text-lg">
                ...
                <li>Legitimate uses permitted under applicable law</li>
                <li>Compliance with legal obligations</li>
              </ul>

              <h4 className="text-lg font-bold text-dark mb-2 mt-6">Consent</h4>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h4 className="text-lg font-bold text-dark mb-2 mt-6">Data Principal Rights</h4>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h4 className="text-lg font-bold text-dark mb-2 mt-6">Data Minimization and Purpose Limitation</h4>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h4 className="text-lg font-bold text-dark mb-2 mt-6">Data Security Safeguards</h4>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h4 className="text-lg font-bold text-dark mb-2 mt-6">Data Breach Notification</h4>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h4 className="text-lg font-bold text-dark mb-2 mt-6">Grievance Redressal</h4>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">15. Changes to This Privacy Policy</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h3 className="text-2xl font-bold text-dark mb-4 mt-8">16. Contact Us</h3>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6">
              ...
              <h4 className="text-lg font-bold text-dark mb-4">Consent</h4>
              <p className="text-slate-650 text-base md:text-lg leading-relaxed mb-6 font-medium">
