...
const ThankYouTrialPage = () => {
  return (
    <GSAPWrapper>
      <SeoMeta title="Thank You | Innvikta" description="Your free trial request has been submitted successfully." />
      
      <section className="relative overflow-hidden w-full min-h-screen flex items-center justify-center py-20" id="thankyou-trial-page">
        {/* Background elements */}
          ...
          <div className="row justify-center">
            ...
            <div className="col-12 md:col-10 lg:col-8 text-center px-4 -translate-y-8">
              ...
              <p className="text-slate-650 text-base md:text-lg max-w-xl mx-auto mb-10 font-medium leading-relaxed">
                We are currently preparing your company dashboard link and will email it to your work address shortly. In the meantime, explore how InSAT helps teams reduce human cyber risk.
              </p>
