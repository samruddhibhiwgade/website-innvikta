      ...
      <div className="container">
        <div className="row items-center">
          ...
          <div className="col-12 xl:col-7 px-4 sm:px-6 md:px-8 xl:px-12">
            <div className="flex md:grid md:grid-cols-3 gap-4 md:gap-6 overflow-x-auto md:overflow-x-visible pb-6 md:pb-0 snap-x snap-mandatory [-ms-overflow-style:none] [scrollbar-width:none] [&::-webkit-scrollbar]:hidden">
              {challenges.cards?.map((card, index) => (
                <div key={index} className="group h-[320px] sm:h-[400px] md:h-[450px] xl:h-[450px] [perspective:1000px] w-[80%] md:w-full shrink-0 snap-align-center">
                  <div className="relative h-full w-full rounded-2xl transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] cursor-pointer">
                    {/* Front */}
                    <div className="absolute inset-0 h-full w-full rounded-2xl bg-[#FFFBF7] border border-orange-100 p-4 xs:p-5 sm:p-6 flex flex-col [backface-visibility:hidden] shadow-sm overflow-hidden text-center justify-between">
                      {index === 0 && (
                        <div className="flex flex-col h-full justify-between">
                          <div className="card-icon-wrapper bg-[#FFEFEA] rounded-full flex items-center justify-center mx-auto w-10 h-10 sm:w-16 sm:h-16 p-2 sm:p-2.5">
                          ...
                          <div className="card-number font-extrabold text-[#f15a24] mt-1 sm:mt-2 text-xl sm:text-3xl md:text-[2.25rem]">$4.4M</div>
                          <div className="card-divider bg-[#f15a24] w-6 sm:w-8 h-[2px] sm:h-[3px] mx-auto my-1 sm:my-2"></div>
                          <h3 className="card-title font-bold text-dark mb-1 sm:mb-2 text-xs sm:text-sm md:text-base lg:text-[1.1rem] leading-snug">Average Global Breach Cost</h3>
                          <p className="card-description text-slate-500 text-[10px] sm:text-xs md:text-sm leading-normal sm:leading-relaxed max-w-[220px] mx-auto mb-1">average global cost of a data breach</p>
                      ...
                      {index === 1 && (
                        <div className="flex flex-col h-full justify-between">
                          ...
                          <div className="card-number font-extrabold text-[#f15a24] mt-1 sm:mt-2 text-xl sm:text-3xl md:text-[2.25rem]">33%</div>
                          <div className="card-divider bg-[#f15a24] w-6 sm:w-8 h-[2px] sm:h-[3px] mx-auto my-1 sm:my-2"></div>
                          <h3 className="card-title font-bold text-dark mb-1 sm:mb-2 text-xs sm:text-sm md:text-base lg:text-[1.1rem] leading-snug">Unapproved AI Usage</h3>
                          <p className="card-description text-slate-500 text-[10px] sm:text-xs md:text-sm leading-normal sm:leading-relaxed max-w-[220px] mx-auto mb-1">employees sharing data with unapproved AI tools</p>
                          <span className="card-source text-[8px] sm:text-[10px] font-bold text-slate-400 uppercase tracking-wider mb-1 block">SOURCE: IBM</span>
                          <div className="card-chart flex justify-center mt-auto">
                              <svg viewBox="0 0 150 92" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full max-w-[70px] sm:max-w-[140px] h-auto mx-auto">
                      ...
                      {index === 2 && (
                        <div className="flex flex-col h-full justify-between">
                          ...
                          <div className="card-number font-extrabold text-[#f15a24] mt-1 sm:mt-2 text-xl sm:text-3xl md:text-[2.25rem]">67%</div>
                          <div className="card-divider bg-[#f15a24] w-6 sm:w-8 h-[2px] sm:h-[3px] mx-auto my-1 sm:my-2"></div>
                          <h3 className="card-title font-bold text-dark mb-1 sm:mb-2 text-xs sm:text-sm md:text-base lg:text-[1.1rem] leading-snug">Fewer Security Incidents</h3>
                          <p className="card-description text-slate-500 text-[10px] sm:text-xs md:text-sm leading-normal sm:leading-relaxed max-w-[220px] mx-auto mb-1">fewer incidents reported after training</p>
