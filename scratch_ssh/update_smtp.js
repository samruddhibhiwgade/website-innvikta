...
conn.on('ready', () => {
  ...
  // Script to append mail settings to .env, and update forms_api.php
  const cmd = `
    # Remove existing MAIL_ variables if they exist to avoid duplication
    sed -i '/^MAIL_/d' /home/platform/public_html/Innvikta-Website/.env
    
    # Append new settings to .env
    echo "" >> /home/platform/public_html/Innvikta-Website/.env
    echo "MAIL_HOST=mail.innvikta.co.in" >> /home/platform/public_html/Innvikta-Website/.env
    echo "MAIL_PORT=587" >> /home/platform/public_html/Innvikta-Website/.env
    echo "MAIL_USERNAME=platform@innvikta.co.in" >> /home/platform/public_html/Innvikta-Website/.env
    echo "MAIL_PASSWORD=8g2A0&jU5h" >> /home/platform/public_html/Innvikta-Website/.env
    echo "MAIL_FROM=platform@innvikta.co.in" >> /home/platform/public_html/Innvikta-Website/.env
    echo "MAIL_FROM_NAME=Innvikta Web Portal" >> /home/platform/public_html/Innvikta-Website/.env
    echo "MAIL_TO=himanshu.tadse@innvikta.com" >> /home/platform/public_html/Innvikta-Website/.env
    
    echo "Updated .env file"
    cat /home/platform/public_html/Innvikta-Website/.env
    
    # Rewrite forms_api.php
    cat << 'EOF' > /home/platform/public_html/Innvikta-Website/Cyberhelp_Innvikta/server/forms_api.php
${phpFormsApi}EOF
    echo "Updated forms_api.php"
  `;
