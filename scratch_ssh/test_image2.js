...
conn.on('ready', () => {
  ...
  const cmd1 = `curl -s -I "http://127.0.0.1:3008/_next/image?url=%2Fimages%2Fbanner-app.png&w=3840&q=75"`;
  // Test 2: Through Apache Proxy
  const cmd2 = `curl -s -I "https://website.innvikta.co.in/_next/image?url=%2Fimages%2Fbanner-app.png&w=3840&q=75"`;
